...
sed -i 's|export KEY_PROVINCE="CA"|export KEY_PROVINCE="MSO"|' /etc/openvpn/easy-rsa/vars
...
sed -i 's|export KEY_EMAIL="me@myhost.mydomain"|export KEY_EMAIL="liernuj25"|' /etc/openvpn/easy-rsa/vars
...
sed -i 's|export KEY_OU=changeme|export KEY_OU=junrielhaya0|' /etc/openvpn/easy-rsa/vars
